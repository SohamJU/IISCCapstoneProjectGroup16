...
_PRODUCT_WORDS = frozenset(
    {
        "filter", "cable", "knob", "burner", "cooktop", "refrigerator", "washer",
        "dryer", "laptop", "computer", "monitor", "display", "case", "cover",
        "charger", "adapter", "battery", "screen", "drive", "card", "kit",
        "replacement", "replacements", "water", "door", "bin", "part", "parts",
        "headphones", "speaker", "camera", "lens", "printer", "keyboard",
        "mouse", "tablet", "phone", "watch", "band", "stand", "mount",
    }
)
